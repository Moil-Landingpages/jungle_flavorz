  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div 
        ...
        style={{
          backgroundImage: 'url(/jungle_flavorz.jpg)',
        }}
      />
      ...
      <div className="absolute inset-0 z-[1] animate-pulse" style={{ 
        background: 'radial-gradient(circle, rgba(212, 175, 55, 0.15) 0%, transparent 50%)',
        animation: 'pulse 8s ease-in-out infinite'
      }} />
      
      <div className="container relative z-10 text-center px-4 py-20">
        <div className="inline-flex items-center gap-2 bg-white/15 backdrop-blur-sm border border-white/30 rounded-full px-6 py-3 mb-8 animate-fade-in-up shadow-lg">
          <Sparkles className="w-4 h-4 text-rich-gold" />
          <span className="text-sm font-semibold text-white tracking-wider">Trusted by EGBI, Dell, IBM & More</span>
        </div>

        <h1 className="font-playfair text-5xl md:text-6xl lg:text-7xl font-black text-white mb-6 leading-tight tracking-tight animate-fade-in-up" style={{ 
          animationDelay: '0.1s',
          ...
          <br />
          <span className="">
            for Austin's Most Memorable Events
          </span>
        </h1>

        <p className="font-inter text-lg md:text-xl text-white/90 mb-2 max-w-3xl mx-auto font-semibold tracking-wide animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
          WHERE CULTURE MEETS CUISINE
        </p>
        
        <p className="font-inter text-lg md:text-xl text-white/85 mb-8 max-w-3xl mx-auto leading-relaxed animate-fade-in-up" style={{ animationDelay: '0.25s' }}>
          From Fortune 500 tech companies to intimate multicultural weddings, we bring the rich culinary traditions of East Africa to Austin's tables, creating unforgettable experiences that honor heritage and unite communities through the universal language of food.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
          {[
            ...
            >
              <div className="font-montserrat text-5xl font-extrabold text-rich-gold mb-2" style={{ textShadow: '2px 2px 8px rgba(0,0,0,0.3)' }}>
                {stat.number}
              </div>
